...
function SvgArchAwsStorageGateway32(props) {
	return (
		<svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" {...props}>
			<defs>
				<linearGradient
					...
					x2="100%"
					y2="0%"
					id="Arch_AWS-Storage-Gateway_32_svg__a"
				>
...
export default SvgArchAwsStorageGateway32;
