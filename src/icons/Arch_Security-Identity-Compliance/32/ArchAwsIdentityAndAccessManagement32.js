...
function SvgArchAwsIdentityAndAccessManagement32(props) {
	return (
		<svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<g fill="none" fillRule="evenodd">
				<path
					d="M0 0h40v40H0z"
					fill="url(#Arch_AWS-Identity-and-Access-Management_32_svg__a)"
				/>
				<path
...
export default SvgArchAwsIdentityAndAccessManagement32;
