...
function SvgArchAmazonElasticContainerKubernetes32(props) {
	return (
		<svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" {...props}>
			<defs>
				<linearGradient
					...
					x2="100%"
					y2="0%"
					id="Arch_Amazon-Elastic-Container-Kubernetes_32_svg__a"
				>
			...
			<g fill="none" fillRule="evenodd">
				<path
					d="M0 0h40v40H0z"
					fill="url(#Arch_Amazon-Elastic-Container-Kubernetes_32_svg__a)"
				/>
				<path
...
export default SvgArchAmazonElasticContainerKubernetes32;
