...
function SvgArchAwsTrustedAdvisor32(props) {
	return (
		<svg width={64} height={64} xmlns="http://www.w3.org/2000/svg" {...props}>
			<defs>
				<linearGradient
					...
					x2="100%"
					y2="0%"
					id="Arch_AWS-Trusted-Advisor_32_svg__a"
				>
...
export default SvgArchAwsTrustedAdvisor32;
